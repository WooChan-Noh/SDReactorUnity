...
public class SDSettings : ScriptableObject
{
    ...
    public string Reactor = "/reactor/image";
...
class SDparamsInReactor
{
    public string sampler_name = "";
    public string source_image = "";
    public string target_image = "";
    public int[] source_faces_index = { 0 };
    public int[] face_index = { 0 };
    public string upscaler = "";
    public int scale = 1;
    public int upscale_visibility = 1;
    public string face_restorer = "";
    public int restorer_visibility = 1;
    public float codeformer_weight = 0.5f;
    public int restore_first = 1;
    public string model = "inswapper_128.onnx";
    public int gender_source = 0;
    public int gender_target = 0;
    public int save_to_file = 0;
    public string result_file_patrh = "";
    public string deivce = "CPU";
}
class SDparamsOutReactor
{
    public string sampler_name = "";
    public string source_image = "";
    public string target_image = "";
